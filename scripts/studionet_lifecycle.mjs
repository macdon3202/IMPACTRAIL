...
const address='0x377A27B57116eB21b2781879348676E4d71170F1';
...
const stateDir=new URL('./.state/',import.meta.url);mkdirSync(stateDir,{recursive:true});const file=new URL('./.state/studionet-v4.json',import.meta.url);
