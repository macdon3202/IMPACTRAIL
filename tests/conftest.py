"""Windows-only compatibility for GenLayer Test Direct Mode stdin injection.

The installed gltest loader unlinks the temporary message file while fd 0 still
references it. POSIX permits that; Windows does not. This shim changes only the
test harness and leaves production contract behavior untouched.
"""
